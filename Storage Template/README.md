...
#### "az group deployment create --resource-group MyAzureRsrcGroup --template-file template1.json". 
...
#### "New-AzResourceGroupDeployment -ResourceGroupName MyAzureRsrcGrp -TemplateFile template1.json".
